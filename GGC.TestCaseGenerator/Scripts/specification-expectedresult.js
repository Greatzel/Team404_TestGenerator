...
function submittingExtraExpectedResults() {
    ...
    for (var g = 1; g <= counting; g++) {
        ...
        res.innerHTML += "<input type = 'hidden' name='expectedResultsName' value='"
            + ExpectedResultsName + "' />";
        res.innerHTML += "<input type = 'hidden' name='expectedResultsText' value='"
            + ExpectedResultsText + "' />";
        res.innerHTML += "<input type = 'hidden' name='expectedResultsCondition' value='"
            + ExpectedResultsCondition + "' />";
    }
}

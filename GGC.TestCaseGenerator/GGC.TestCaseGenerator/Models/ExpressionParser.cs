...
namespace GGC.TestCaseGenerator.Models
{
    ...
    public class ExpressionParser
    {
        ...
        private static Expression ParseOr(IList<string> expressionTokens, ref int index)
        {
            ...
            return Expression.ExpressionBinary.Build(operands, OperatorOr);
        }
        ...
        private static Expression ParseAnd(IList<string> expressionTokens, ref int index)
        {
            ...
            return Expression.ExpressionBinary.Build(operands, OperatorAnd);
        }
        ...
        private static Expression ParseNot(IList<string> expressionTokens, ref int index)
        {
            ...
            return Expression.ExpressionUnary.Build(ParseRelational(expressionTokens, ref index), unaryOperator);
        }
        ...
        private static Expression ParseRelational(IList<string> expressionTokens, ref int index)
        {
            ...
            return Expression.ExpressionRelational.Build(operands, relationalOperator);
        }
        ...
        private static Expression ParseOperand(IList<string> expressionTokens, ref int index)
        {
            ...
            if (token == BracketLeft)
            {
                ...
                index++;
                return Expression.ExpressionOperand.Build(alternatives);
            }

            index++;
            return Expression.ExpressionOperand.Build(token);
        }

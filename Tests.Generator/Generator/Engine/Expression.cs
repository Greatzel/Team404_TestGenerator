...
namespace Generator.Engine
{
    ...
    {
        /// <summary>
        /// Reads the XML element for the expression and returns true if successful.
        /// </summary>
        public virtual bool ReadAsXml(XElement xExpression)
        {
            return true;
        }
    ...
    public class ExpressionBinary : Expression
    {
        ...
        /// <summary>
        /// Reads the XML element for the binary expression and returns true if successful.
        /// </summary>
        public override bool ReadAsXml(XElement xExpression)
        {
            string binaryOperator = TestSpecification.XmlField(xExpression, "Operator");
            ...
            return Set(binaryOperator, expressions);
        }
